...
SVC_NAME="actions.runner.lakshmi123a-vault-action-exampleapp.Lakshmis-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (lakshmi123a-vault-action-exampleapp.Lakshmis-MacBook-Pro)"
